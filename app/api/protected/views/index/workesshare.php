...
<html>
	...
	<div class="select-wrap1">
			<div class="workes-wrap">
				...
				<p class="mtop" style="overflow: hidden;"><span class="span-oun">标签</span>
						...
						<span class="bor-rad ios-rad" labelid="<?= Html::encode($label['product_label_id']) ?>"><?= Html::encode($label['name']) ?></span>
			...
			<div class="mui-content-padded" data-pswp-uid="1">	
						...
						<figure>
							<span>
							  ...
							  <img  _src="<?= Html::encode($image->source) ?>" src="" style="width: 10rem;">
							  </a>
							</span>
						</figure>
						<?php endforeach; ?>		
			...
			<div class="backpic-conter">
				<?php foreach($info['status'] as $status): ?>
					...
					<a href="/assets/"><span class="biao-yl"><?= Html::encode($status['comment_number']) ?></span></a>
				</div>
				</div>
				<?php endforeach; ?>
				<ul class="work-tab">
					<li class="wo-pl sel-bor"><span>评论(<?= Html::encode($info['comment_number']) ?>)</span></li>
					<li class="wo-dz"><span>点赞(<?= Html::encode($info['praise_number']) ?>)</span></li>
				</ul>
	...
	<script src="/assets/js/zyComment.js" type="text/javascript" charset="utf-8"></script>
	...
	window.onload=window.onscroll=function () {
		var con=$(".mui-content-padded img");
		var scrollT=document.body.scrollTop||document.documentElement.scrollTop;
		var winh=document.documentElement.clientHeight;
		for (var i = 0; i < con.length; i++) {
			if (offsetTL(con[i]).top<=scrollT+winh) {
				con[i].src=con[i].getAttribute("_src");
			};
		};
	}
