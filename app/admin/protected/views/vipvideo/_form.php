                                ...
                                <?php switch($field['html']): ?><?php case 'image': ?>
                                    ...
                                    <div id="thumbnail">
                                        <?php if($field['value'] && is_array($field['value'])): ?>
                                            <?php foreach($field['value'] as $image_url): ?>
                                                <div class="media radius clearfix" style="float:left;margin-left:15px;margin-top:0px;">
                                                    <a class="del" href="javascript:;" alt="删除"><img style="max-width: 200px;" src="<?= $image_url ?>" ></a>
                                                    <div class="media-body" style="display:none">
                                                        <input name="<?= $field['key'] ?>[url][]" type="hidden" class="input" value="<?= $image_url ?>" />
                                                    </div>
                                                </div>
                                            <?php endforeach;?>
                                        <?php endif; ?>
