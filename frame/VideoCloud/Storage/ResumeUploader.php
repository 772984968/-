<?php
namespace yii\VideoCloud\Storage;

use yii\VideoCloud\Http\Client;
use yii\VideoCloud\Http\Error;
use yii\VideoCloud\Config;
...
final class ResumeUploader
{
    ...
    public static function getInitData(
        ...
        //$NONCE = (string)(rand(0,pow(10, 8)).rand(0,pow(10, 8)));
