...
class curl {
    ...
    public static function curl_get_contents($url,$data = array(), $https = false)
    {
        $results['error']   = '';
        $results['status']  = 0;
        $results['data']    = array();
    ...
    public static function  curl_https_post($url, $data)
    {
    ...
    public static function curl_https_get($url)
    {
    ...
    // CURL https post 方式提交数据
    public static function curl_http_post($url, $data = array())
    {
